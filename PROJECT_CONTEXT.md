...
- امکان دریافت فوری کد جایگزین بدون فاصله‌ی انتظار در فاز QA؛ فقط جدیدترین Challenge معتبر بررسی می‌شود؛
...
- افزودن Rate Limit واقعی OTP در Provider/Edge همزمان با اتصال SMS؛
