...
- جلوگیری از Zoom ناخواسته‌ی WebView/Safari در پروفایل موبایل با Viewport صریح، Input شانزده‌پیکسلی، کنترل Text Autosizing و پنل سازگار با Safe Area؛
...
- ۲۳ تست واحد موفق برای Schedule نسخه‌بندی‌شده، Burst و فاصله‌ی بازیابی، سرعت/زاویه‌ی پرتاب، Combo scoring، افزایش سختی، Hit validation، تنظیم امن Cookie، خطاهای شماره موبایل، نشست کاربر مسدود و Guard ادمین؛
