...
- ۲۷ تست واحد موفق برای Schedule نسخه‌بندی‌شده، Burst و فاصله‌ی بازیابی، سرعت/زاویه‌ی پرتاب، Combo scoring، افزایش سختی، Hit validation، تنظیم امن Cookie، خطاهای شماره موبایل، محدودیت OTP، ثبت‌نام تکراری، جایزه‌ی معرف پس از بازی، نشست کاربر مسدود و Guard ادمین؛
