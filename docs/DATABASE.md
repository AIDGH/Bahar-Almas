...
- درخواست فوری کد جایگزین مجاز است؛ Verify فقط جدیدترین Challenge معتبر و مصرف‌نشده‌ی شماره را بررسی می‌کند و Challengeهای منقضی باید در پاک‌سازی دوره‌ای حذف شوند.
