...
- نقش `USER` یا `ADMIN`؛
- وضعیت مسدودی نرم و زمان مسدودشدن؛
- ارتباط با Sessionها و Game Sessionها.

مسدودسازی User را پاک نمی‌کند تا تاریخچه و قابلیت بررسی ادمین حفظ شود. Sessionهای او در زمان Ban حذف و رکوردش در Query لیدربورد فیلتر می‌شود.
...
Migration اولیه در `20260904000000_init`، Migration بازی مهمان/پروفایل/دعوت در `20260908000000_guest_games_profiles_referrals` و Migration نقش ادمین/مسدودی در `20260909000000_admin_users_and_bans` قرار دارند.
